...
extension LiteNetwork: URLSessionDelegate {
...
extension LiteNetwork: URLSessionTaskDelegate {
...
extension LiteNetwork:  URLSessionDataDelegate {
    /// 收到部分预期数据
    /// - Parameters:
    ///   - session: 包含符合条件task的session
...
extension LiteNetwork: URLSessionDownloadDelegate {
    /// 已完成下载任务
    /// - Parameters:
    ///   - session: 包含符合条件task的session
...
extension LiteNetwork: LiteNetworkTokenDelegate {
